 ...
 * <ul>
 *   <li>{@link org.neclipse.xtext.training.smallfunc.smallFuncDsl.impl.ClassTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassTypeImpl extends DataTypeImpl implements ClassType
{
  ...
  {
    return SmallFuncDslPackage.Literals.CLASS_TYPE;
  }
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmallFuncDslPackage.CLASS_TYPE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(SmallClass newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SmallFuncDslPackage.CLASS_TYPE__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SmallFuncDslPackage.CLASS_TYPE__TYPE:
