...
import org.neclipse.xtext.validator.example.clazzdsl.clazzDsl.ClazzDslFactory;
 ...
 * @generated
 */
public class ClazzDslPackageImpl extends EPackageImpl implements ClazzDslPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.neclipse.xtext.validator.example.clazzdsl.clazzDsl.ClazzDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private ClazzDslPackageImpl()
  {
    super(eNS_URI, ClazzDslFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link ClazzDslPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static ClazzDslPackage init()
  {
    if (isInited) return (ClazzDslPackage)EPackage.Registry.INSTANCE.getEPackage(ClazzDslPackage.eNS_URI);

    // Obtain or create and register package
    ClazzDslPackageImpl theClazzDslPackage = (ClazzDslPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ClazzDslPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ClazzDslPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theClazzDslPackage.createPackageContents();

    // Initialize created meta-data
    theClazzDslPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theClazzDslPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(ClazzDslPackage.eNS_URI, theClazzDslPackage);
    return theClazzDslPackage;
  }
   ...
   * @generated
   */
  public EReference getNamespace_Clazz()
  {
   ...
   * @generated
   */
  public ClazzDslFactory getClazzDslFactory()
  {
    return (ClazzDslFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(namespaceEClass, NAMESPACE__CLAZZ);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getNamespace_Clazz(), this.getClazz(), null, "clazz", null, 0, 1, Namespace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
