...
public class ClazzDslSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ClazzDslGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (ClazzDslGrammarAccess) access;
	}
