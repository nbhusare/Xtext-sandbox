 ...
 * ******************************************************************************
 */
package org.nb.xtext.example.hyperlink.entitydsl.entityDsl.util;
...
public class EntityDslAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EntityDslSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseEntityFile(EntityFile object)
      {
        return createEntityFileAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.nb.xtext.example.hyperlink.entitydsl.entityDsl.EntityFile <em>Entity File</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createEntityFileAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.nb.xtext.example.hyperlink.entitydsl.entityDsl.Import <em>Import</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.nb.xtext.example.hyperlink.entitydsl.entityDsl.Entity <em>Entity</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
