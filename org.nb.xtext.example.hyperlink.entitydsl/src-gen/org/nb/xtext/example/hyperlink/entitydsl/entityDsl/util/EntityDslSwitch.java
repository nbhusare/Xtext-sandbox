...
public class EntityDslSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        EntityFile entityFile = (EntityFile)theEObject;
        T result = caseEntityFile(entityFile);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Entity File</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Entity File</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEntityFile(EntityFile object)
  {
    return null;
  }
