...
import org.nb.xtext.example.hyperlink.entitydsl.entityDsl.EntityDslFactory;
...
public class EntityDslPackageImpl extends EPackageImpl implements EntityDslPackage
{
   ...
   * @generated
   */
  private EClass entityFileEClass = null;
   ...
   * @see org.nb.xtext.example.hyperlink.entitydsl.entityDsl.EntityDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EClass getEntityFile()
  {
    return entityFileEClass;
  }
   ...
   * @generated
   */
  public EAttribute getEntityFile_Name()
  {
    return (EAttribute)entityFileEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getEntityFile_Imports()
  {
    return (EReference)entityFileEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getEntityFile_Entity()
  {
    return (EReference)entityFileEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    entityFileEClass = createEClass(ENTITY_FILE);
    createEAttribute(entityFileEClass, ENTITY_FILE__NAME);
    createEReference(entityFileEClass, ENTITY_FILE__IMPORTS);
    createEReference(entityFileEClass, ENTITY_FILE__ENTITY);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(entityFileEClass, EntityFile.class, "EntityFile", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getEntityFile_Name(), ecorePackage.getEString(), "name", null, 0, 1, EntityFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEntityFile_Imports(), this.getImport(), null, "imports", null, 0, -1, EntityFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getEntityFile_Entity(), this.getEntity(), null, "entity", null, 0, 1, EntityFile.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
