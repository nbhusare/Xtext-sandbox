...
public class SmallJavaDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.neclipse.xtend.training.smallJava.SmallJavaDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.neclipse.org/xtend/training/smallJava/SmallJavaDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.neclipse.org/xtend/training/smallJava/SmallJavaDsl", org.neclipse.xtend.training.smallJava.smallJavaDsl.SmallJavaDslPackage.eINSTANCE);
	}
