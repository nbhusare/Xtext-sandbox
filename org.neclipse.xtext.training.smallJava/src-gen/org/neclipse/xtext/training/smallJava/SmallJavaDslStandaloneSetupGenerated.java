...
public class SmallJavaDslStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.neclipse.xtext.training.smallJava.SmallJavaDslRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.neclipse.org/xtext/training/smallJava/SmallJavaDsl")) {
		EPackage.Registry.INSTANCE.put("http://www.neclipse.org/xtext/training/smallJava/SmallJavaDsl", org.neclipse.xtext.training.smallJava.smallJavaDsl.SmallJavaDslPackage.eINSTANCE);
	}
