...
public class SmallJavaDslParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected org.neclipse.xtext.training.smallJava.parser.antlr.internal.InternalSmallJavaDslParser createParser(XtextTokenStream stream) {
		return new org.neclipse.xtext.training.smallJava.parser.antlr.internal.InternalSmallJavaDslParser(stream, getGrammarAccess());
	}
